...
$('document').ready(function () {
        ...
        $.get({
            ...
            .done(function (data) {
                if (data) {
                    ...
                    datamanager.setDataSource('block-catalogue', {data:[], flavors: data});
                }
            }.bind(this))
            .fail(function (err) {
                if (attempts< 3)
    ...
    datamanager.onDataSourceSet(volumeComponent, function (sourceData) {
        ...
        var createVolume = function(form, containerNode){
        ...
        var modalCreateFields =[
            ...
            },
            {
                ...
                type:'checkbox',
                field:'input',
                name:'imageRefCheckbox',
                label:'Is a bootable volume',
                validate:{
                    required:false
                }
            },
            {
                ...
                options: function(){
                    ...
                    var instanceSource = sourceData.flavors.flavors;
        ...
        sourceData.actions = [
            {
                ...
                onClick: function (props, state) {
                    ...
                    var modalParams = {
                            ...
                            type:'form',
                            conditions:{
                                imageRef:'imageRefCheckbox'
                            },
                            fields: modalCreateFields,
                            onAccept: createVolume.bind(node),
                            onClose: function () {
